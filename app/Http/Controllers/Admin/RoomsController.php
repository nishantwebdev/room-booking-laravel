...
class RoomsController extends Controller
{
    ...
    public function create()
    {
        ...
        if (! Gate::allows('room_create')) {
          ...
          $buildings = Buildings::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');

        $categories = Category::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
        return view('admin.rooms.create',compact('categories','buildings'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.rooms.edit', compact('room','categories','buildings'));
    }
